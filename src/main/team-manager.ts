...
export class TeamManager {
  ...
  buildCoordinatorSystemBlock(teamId: string): string | null {
    ...
    return [
      ...
      '- Do NOT impersonate or role-play team members in your own reply.',
      '- Each member is a REAL separate API sub-agent with its own system prompt from ~/.koder/team/.',
      '- Use tools to delegate work:',
      '  • delegate_agent(member_id, task) — run one member',
